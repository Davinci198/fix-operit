/* METADATA
{
    ...
    "description": {
        ...
        "ro": "Comprehensive file format conversion. Supports converting between common audio/video (MP4, MOV, MP3, WAV), images (JPG, PNG, WEBP), and documents (Markdown, HTML, DOCX, PDF)."
    },
    ...
    "tools": [
        {
            ...
            "description": {
                ...
                "ro": "Convert files using external CLI tools such as FFmpeg, ImageMagick, and Pandoc. Supports audio/video, images, and documents. If a required tool is missing, it will attempt to install it automatically."
            },
            "parameters": [
                {
                    "name": "input_path",
                ...
                },
                {
                    "name": "output_path",
                    "description": {
                        "zh": "输出文件的路径。扩展名决定了目标格式。",
                        "en": "Output file path. The file extension determines the target format.",
                        "ro": "Output file path. The file extension determines the target format."
                    },
                    "type": "string",
                    "required": true
                },
                {
                    "name": "options",
                    "description": {
                        "zh": "用于转换工具的可选命令行选项 (例如, 为 ImageMagick 设置 '-quality 80' )。",
                        "en": "Optional CLI options for the conversion tool (e.g. set '-quality 80' for ImageMagick).",
                        "ro": "Optional CLI options for the conversion tool (e.g. set '-quality 80' for ImageMagick)."
                    },
                    "type": "string",
                    "required": false
                }
