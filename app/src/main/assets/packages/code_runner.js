/* METADATA
{
  ...
  description: { zh: "提供多语言代码执行能力，支持JavaScript、Python、Ruby、Go、Rust、C和C++脚本的运行。可直接执行代码字符串或运行外部文件，适用于快速测试、自动化脚本和教学演示。", en: "Multi-language code execution. Supports running JavaScript, Python, Ruby, Go, Rust, C and C++ scripts. You can execute code strings directly or run external files, useful for quick tests, automation, and demos."
        ro: "Multi-language code execution. Supports running JavaScript, Python, Ruby, Go, Rust, C and C++ scripts. You can execute code strings directly or run external files, useful for quick tests, automation, and demos."
    }
  ...
  tools: [
    {
      ...
      description: { zh: "运行自定义 JavaScript (ES5) 脚本。会捕获 console.log 的输出以及最终的返回值。", en: "Run custom JavaScript (ES5). Captures console.log output and the final return value."
        ro: "Run custom JavaScript (ES5). Captures console.log output and the final return value."
    }
      ...
      parameters: [
        ...
        ro: "JavaScript script content to execute."
    }
          type: string
          required: true
        }
    ...
    },
    {
      ...
      description: { zh: "运行 JavaScript (ES5) 文件。会捕获 console.log 的输出以及最终的返回值。", en: "Run a JavaScript (ES5) file. Captures console.log output and the final return value."
        ro: "Run a JavaScript (ES5) file. Captures console.log output and the final return value."
    }
      parameters: [
        {
          name: file_path
          description: { zh: "JavaScript 文件路径", en: "Path to the JavaScript file."
        ro: "Path to the JavaScript file."
    }
          type: string
          required: true
        }
    ...
    },
    {
      ...
      description: { zh: "使用 Node.js 运行 JavaScript 脚本。返回 stdout/stderr 输出。", en: "Run JavaScript using Node.js. Returns stdout/stderr output."
        ro: "Run JavaScript using Node.js. Returns stdout/stderr output."
    }
      parameters: [
        {
          name: script
        ...
        ro: "Node.js interpreter flags (default: empty). Examples: --trace-warnings, --no-warnings."
    }
          type: string
          required: false
        }
    ...
    },
    {
      ...
      description: { zh: "使用 Node.js 运行 JavaScript 文件。返回 stdout/stderr 输出。", en: "Run a JavaScript file using Node.js. Returns stdout/stderr output."
        ro: "Run a JavaScript file using Node.js. Returns stdout/stderr output."
    }
      parameters: [
        {
          name: file_path
    ...
    },
    {
      ...
      description: { zh: "在持久 Node 工作目录($HOME/.code_runner/node)中安装 pnpm 包", en: "Install packages with pnpm in the persistent Node workspace ($HOME/.code_runner/node)."
        ro: "Install packages with pnpm in the persistent Node workspace ($HOME/.code_runner/node)."
    }
      parameters: [
        {
          name: packages
        ...
        ro: "Package names to install, separated by | (e.g. axios|lodash|@types/node)."
    }
          type: string
          required: true
        },
        ...
        ro: "Whether to install as dev dependency (pnpm add -D)."
    }
          type: boolean
          required: false
        }
    ...
    },
    {
      ...
      description: { zh: "在持久虚拟环境(~/.code_runner/py)中安装 Python 包（使用 pip）", en: "Install Python packages in the persistent virtual environment (~/.code_runner/py) using pip."
        ro: "Install Python packages in the persistent virtual environment (~/.code_runner/py) using pip."
    }
      parameters: [
        {
          name: packages
          description: { zh: "要安装的包名（用 | 分隔），例如 numpy|pydantic==2.*", en: "Package names to install, separated by | (e.g. numpy|pydantic==2.*)."
        ro: "Package names to install, separated by | (e.g. numpy|pydantic==2.*)."
    }
          type: string
          required: true
        },
        ...
        ro: "Whether to upgrade already installed packages (equivalent to pip -U)."
    }
          type: boolean
          required: false
        }
    ...
    },
    {
      ...
      description: { zh: "运行自定义 Python 脚本。会捕获 print 函数的输出。", en: "Run custom Python scripts. Captures output from print()."
        ro: "Run custom Python scripts. Captures output from print()."
    }
      parameters: [
        {
          name: script
          description: { zh: "要执行的 Python 脚本内容", en: "Python script content to execute."
        ro: "Python script content to execute."
    }
          type: string
          required: true
        },
        ...
        ro: "Python interpreter flags (default: empty). Examples: -O (optimize), -u (unbuffered)."
    }
          type: string
          required: false
        },
        ...
        ro: "Arguments passed to the Python script, separated by | (e.g. arg1|arg with space|--name=alice)."
    }
          type: string
          required: false
        }
    ...
    },
    {
      ...
      description: { zh: "运行 Python 文件。会捕获 print 函数的输出。", en: "Run a Python file. Captures output from print()."
        ro: "Run a Python file. Captures output from print()."
    }
      parameters: [
        {
          name: file_path
          description: { zh: "Python 文件路径", en: "Path to the Python file."
        ro: "Path to the Python file."
    }
          type: string
          required: true
        },
        ...
        ro: "Arguments passed to the Python file, separated by | (e.g. arg1|arg with space|--name=alice)."
    }
          type: string
          required: false
        }
    ...
    },
    {
      ...
      parameters: [
        ...
        ro: "Ruby interpreter flags (default: empty). Example: --jit."
    }
          type: string
          required: false
        }
    ...
    },
    {
      ...
      parameters: [
        ...
        ro: "Go build flags (default: empty). Example: -ldflags='-s -w' (reduce binary size)."
    }
          type: string
          required: false
        }
    ...
    },
    {
      ...
      parameters: [
        ...
        ro: "Cargo build flags (default: --release). Examples: empty string (debug), --release --features xxx."
    }
          type: string
          required: false
        }
    ...
    },
    {
      ...
      parameters: [
        ...
        ro: "Compile flags (default: -O3 -march=native -fopenmp). Examples: -O2, -O0 -g."
    }
          type: string
          required: false
        }
