/* METADATA
{
    ...
    "description": {
        ...
        "ro": "FFmpeg utilities for processing multimedia content."
    },
    ...
    "tools": [
        {
            "name": "ffmpeg_execute",
            "description": {
                "zh": "执行自定义FFmpeg命令（仅填写参数，不要包含前缀 ffmpeg）。",
                "en": "Execute a custom FFmpeg command (arguments only; do not include the leading ffmpeg).",
                "ro": "Execute a custom FFmpeg command (arguments only; do not include the leading ffmpeg)."
            },
            "parameters": [
                {
                    "name": "command",
                    "description": {
                        "zh": "要执行的FFmpeg命令参数（不要包含前缀 ffmpeg）",
                        "en": "FFmpeg command arguments to execute (do not include the leading ffmpeg)",
                        "ro": "FFmpeg command arguments to execute (do not include the leading ffmpeg)"
                    },
                    "type": "string",
                    "required": true
                }
        ...
        },
        {
            "name": "ffmpeg_info",
            "description": {
                "zh": "获取FFmpeg系统信息，包括版本、构建配置和支持的编解码器。",
                "en": "Get FFmpeg system info, including version, build config, and supported codecs.",
                "ro": "Get FFmpeg system info, including version, build config, and supported codecs."
            },
            "parameters": []
        },
        {
            ...
            "description": {
                "zh": "使用简化参数转换视频文件。",
                "en": "Convert a video file using simplified parameters.",
                "ro": "Convert a video file using simplified parameters."
            },
            "parameters": [
                {
                    "name": "input_path",
                    "description": {
                        "zh": "源视频文件路径",
                        "en": "Input video file path",
                        "ro": "Input video file path"
                    },
                    "type": "string",
                    "required": true
                },
                {
                    ...
                    "description": {
                        "zh": "目标视频文件路径",
                        "en": "Output video file path",
                        "ro": "Output video file path"
                    },
                    "type": "string",
                    "required": true
                },
                {
                    "name": "video_codec",
                    "description": {
                        "zh": "可选，要使用的视频编解码器。推荐使用 'h264'。支持的值: 'h264', 'hevc', 'vp8', 'vp9', 'av1', 'libx265', 'libvpx', 'libaom', 'mpeg4', 'mjpeg', 'prores'。",
                        "en": "Optional. Video codec to use. Prefer 'h264'. Supported values: 'h264', 'hevc', 'vp8', 'vp9', 'av1', 'libx265', 'libvpx', 'libaom', 'mpeg4', 'mjpeg', 'prores'.",
                        "ro": "Optional. Video codec to use. Prefer 'h264'. Supported values: 'h264', 'hevc', 'vp8', 'vp9', 'av1', 'libx265', 'libvpx', 'libaom', 'mpeg4', 'mjpeg', 'prores'."
                    },
                    "type": "string",
                    "required": false
                },
                {
                    "name": "audio_codec",
                    "description": {
                        "zh": "可选，要使用的音频编解码器。支持的值: 'aac', 'mp3', 'opus', 'vorbis', 'flac', 'pcm', 'wav', 'ac3', 'eac3'。",
                        "en": "Optional. Audio codec to use. Supported values: 'aac', 'mp3', 'opus', 'vorbis', 'flac', 'pcm', 'wav', 'ac3', 'eac3'.",
                        "ro": "Optional. Audio codec to use. Supported values: 'aac', 'mp3', 'opus', 'vorbis', 'flac', 'pcm', 'wav', 'ac3', 'eac3'."
                    },
                    "type": "string",
                    "required": false
                },
                {
                    "name": "resolution",
                    "description": {
                        "zh": "可选，输出分辨率，例如 '1280x720'。",
                        "en": "Optional. Output resolution, e.g. '1280x720'.",
                        "ro": "Optional. Output resolution, e.g. '1280x720'."
                    },
                    "type": "string",
                    "required": false
                },
                {
                    "name": "bitrate",
                    "description": {
                        "zh": "可选，视频比特率，例如 '1000k'。",
                        "en": "Optional. Video bitrate, e.g. '1000k'.",
                        "ro": "Optional. Video bitrate, e.g. '1000k'."
                    },
                    "type": "string",
                    "required": false
                }
