/* METADATA
{
    ...
    "description": {
        "zh": "基于 GitHub REST API 的工具集合（不依赖 GitHub MCP）。包含 GitHub 侧（仓库/Issues/PR/文件提交/分支/差异提交）与本地侧（apply_file 差异更新、terminal 终端）能力。",
        "en": "A toolkit built on the GitHub REST API (does not depend on GitHub MCP). Includes GitHub-side operations (repos/issues/PRs/commits/branches/diffs) and local-side utilities (apply_file patch updates, terminal).",
        "ro": "A toolkit built on the GitHub REST API (does not depend on GitHub MCP). Includes GitHub-side operations (repos/issues/PRs/commits/branches/diffs) and local-side utilities (apply_file patch updates, terminal)."
    },
    ...
    "env": [
        {
            ...
            "description": {
                ...
                "ro": "GitHub API authentication token"
            },
            "required": true
        },
        {
    ...
    "tools": [
        {
            ...
            "description": {
                ...
                "ro": "Search GitHub repositories (/search/repositories)."
            },
            "parameters": [
                {
                    "name": "query",
                    "description": {
                        ...
                        "ro": "Search keywords (GitHub search query)."
                    },
                    "type": "string",
                    "required": true
                },
                {
                    ...
                    "description": {
                        ...
                        "ro": "Sort field: stars/forks/help-wanted-issues/updated."
                    },
                    "type": "string",
                    "required": false
                },
                ...
                },
                {
                    ...
                    "description": {
                        ...
                        "ro": "Items per page (default: 30, max: 100)."
                    },
                    "type": "number",
                    "required": false
                }
        ...
        },
        {
            ...
            "description": {
                ...
                "ro": "Get repository information (/repos/{owner}/{repo})."
            },
            "parameters": [
                {
                    "name": "owner",
        ...
        },
        {
            "name": "list_issues",
            "description": {
                "zh": "列出仓库 Issues（/repos/{owner}/{repo}/issues）。注意：GitHub 的 issues API 默认也会包含 PR，需要时可用 include_pull_requests 控制。",
                "en": "List repository issues (/repos/{owner}/{repo}/issues). Note: GitHub issues API also includes PRs by default; use include_pull_requests when needed.",
                "ro": "List repository issues (/repos/{owner}/{repo}/issues). Note: GitHub issues API also includes PRs by default; use include_pull_requests when needed."
            },
            "parameters": [
                {
                    "name": "owner",
                ...
                },
                {
                    ...
                    "description": {
                        ...
                        "ro": "open/closed/all (default: open)."
                    },
                    "type": "string",
                    "required": false
                },
                ...
                },
                {
                    ...
                    "description": {
                        "zh": "是否保留 PR（默认 false，仅返回 issue）",
                        "en": "Whether to include PRs (default: false; issues only).",
                        "ro": "Whether to include PRs (default: false; issues only)."
                    },
                    "type": "boolean",
                    "required": false
                }
        ...
        },
        {
            ...
            "description": {
                ...
                "en": "Create an issue (/repos/{owner}/{repo}/issues).",
                "ro": "Create an issue (/repos/{owner}/{repo}/issues)."
            },
            "parameters": [
                {
                    "name": "owner",
                ...
                },
                {
                    ...
                    "description": {
                        "zh": "labels 数组（字符串数组）",
                        "en": "Labels array (string array).",
                        "ro": "Labels array (string array)."
                    },
                    "type": "array",
                    "required": false
                },
                {
                    "name": "assignees",
                    "description": {
                        "zh": "assignees 数组（字符串数组）",
                        "en": "Assignees array (string array).",
                        "ro": "Assignees array (string array)."
                    },
                    "type": "array",
                    "required": false
                }
        ...
        },
        {
            "name": "comment_issue",
            "description": {
                "zh": "给 Issue/PR 评论（/repos/{owner}/{repo}/issues/{issue_number}/comments）。",
                "en": "Comment on an issue/PR (/repos/{owner}/{repo}/issues/{issue_number}/comments).",
                "ro": "Comment on an issue/PR (/repos/{owner}/{repo}/issues/{issue_number}/comments)."
            },
            "parameters": [
                {
                    "name": "owner",
        ...
        },
        {
            ...
            "description": {
                "zh": "列出 Issue/PR 的评论（/repos/{owner}/{repo}/issues/{issue_number}/comments）。",
                "en": "List comments on an issue/PR (/repos/{owner}/{repo}/issues/{issue_number}/comments).",
                "ro": "List comments on an issue/PR (/repos/{owner}/{repo}/issues/{issue_number}/comments)."
            },
            "parameters": [
                {
                    "name": "owner",
        ...
        },
        {
            ...
            "description": {
                ...
                "en": "List pull requests (/repos/{owner}/{repo}/pulls).",
                "ro": "List pull requests (/repos/{owner}/{repo}/pulls)."
            },
            "parameters": [
                {
                    "name": "owner",
                ...
                },
                {
                    ...
                    "description": {
                        "zh": "head 过滤（可选）",
                        "en": "Head filter (optional).",
                        "ro": "Head filter (optional)."
                    },
                    "type": "string",
                    "required": false
                },
                {
                    ...
                    "description": {
                        "zh": "base 过滤（可选）",
                        "en": "Base filter (optional).",
                        "ro": "Base filter (optional)."
                    },
                    "type": "string",
                    "required": false
                },
        ...
        },
        {
            ...
            "description": {
                "zh": "创建 PR（/repos/{owner}/{repo}/pulls）。",
                "en": "Create a pull request (/repos/{owner}/{repo}/pulls).",
                "ro": "Create a pull request (/repos/{owner}/{repo}/pulls)."
            },
            "parameters": [
                {
                    "name": "owner",
                ...
                },
                {
                    "name": "head",
                    "description": {
                        "zh": "源分支，例如 feature-branch 或 owner:branch",
                        "en": "Head branch, e.g. feature-branch or owner:branch.",
                        "ro": "Head branch, e.g. feature-branch or owner:branch."
                    },
                    "type": "string",
                    "required": true
                },
                {
                    ...
                    "description": {
                        "zh": "目标分支，例如 main",
                        "en": "Base branch, e.g. main.",
                        "ro": "Base branch, e.g. main."
                    },
                    "type": "string",
                    "required": true
                },
                ...
                },
                {
                    ...
                    "description": {
                        "zh": "是否为 Draft",
                        "en": "Whether this is a draft PR.",
                        "ro": "Whether this is a draft PR."
                    },
                    "type": "boolean",
                    "required": false
                }
        ...
        },
        {
            ...
            "description": {
                "zh": "获取 PR 详情（/repos/{owner}/{repo}/pulls/{pull_number}）。",
                "en": "Get pull request details (/repos/{owner}/{repo}/pulls/{pull_number}).",
                "ro": "Get pull request details (/repos/{owner}/{repo}/pulls/{pull_number})."
            },
            "parameters": [
                {
                    "name": "owner",
        ...
        },
        {
            ...
            "description": {
                "zh": "合并 PR（/repos/{owner}/{repo}/pulls/{pull_number}/merge）。",
                "en": "Merge a pull request (/repos/{owner}/{repo}/pulls/{pull_number}/merge).",
                "ro": "Merge a pull request (/repos/{owner}/{repo}/pulls/{pull_number}/merge)."
            },
            "parameters": [
                {
                    "name": "owner",
                ...
                },
                {
                    "name": "commit_title",
                    "description": {
                        "zh": "可选，merge commit 标题",
                        "en": "Optional: merge commit title.",
                        "ro": "Optional: merge commit title."
                    },
                    "type": "string",
                    "required": false
                },
                {
                    "name": "commit_message",
                    "description": {
                        "zh": "可选，merge commit 内容",
                        "en": "Optional: merge commit message.",
                        "ro": "Optional: merge commit message."
                    },
                    "type": "string",
                    "required": false
                },
                {
                    "name": "merge_method",
                    "description": {
                        "zh": "merge/squash/rebase",
                        "en": "merge/squash/rebase.",
                        "ro": "merge/squash/rebase."
                    },
                    "type": "string",
                    "required": false
                }
        ...
        },
        {
            ...
            "description": {
                "zh": "读取仓库文件内容（/repos/{owner}/{repo}/contents/{path}）。若文件是 base64 返回，将自动解码为文本并返回。",
                "en": "Read repository file content (/repos/{owner}/{repo}/contents/{path}). If the API returns base64, it will be decoded and returned as text.",
                "ro": "Read repository file content (/repos/{owner}/{repo}/contents/{path}). If the API returns base64, it will be decoded and returned as text."
            },
            "parameters": [
                {
                    "name": "owner",
                ...
                },
                {
                    ...
                    "description": {
                        "zh": "文件路径（如 README.md）",
                        "en": "File path (e.g. README.md).",
                        "ro": "File path (e.g. README.md)."
                    },
                    "type": "string",
                    "required": true
                },
                {
                    ...
                    "description": {
                        "zh": "分支/Tag/SHA（可选）",
                        "en": "Branch/Tag/SHA (optional).",
                        "ro": "Branch/Tag/SHA (optional)."
                    },
                    "type": "string",
                    "required": false
                }
        ...
        },
        {
            ...
            "description": {
                "zh": "创建或更新仓库文件并提交（/repos/{owner}/{repo}/contents/{path}，PUT）。",
                "en": "Create or update a repository file and commit it (/repos/{owner}/{repo}/contents/{path}, PUT).",
                "ro": "Create or update a repository file and commit it (/repos/{owner}/{repo}/contents/{path}, PUT)."
            },
            "parameters": [
                {
                    "name": "owner",
                ...
                },
                {
                    "name": "content",
                    "description": {
                        "zh": "文件内容（默认按 utf-8 文本编码为 base64）",
                        "en": "File content (base64-encoded as utf-8 text by default).",
                        "ro": "File content (base64-encoded as utf-8 text by default)."
                    },
                    "type": "string",
                    "required": true
                },
                {
                    ...
                    "description": {
                        "zh": "utf-8/base64（默认 utf-8）",
                        "en": "utf-8/base64 (default: utf-8).",
                        "ro": "utf-8/base64 (default: utf-8)."
                    },
                    "type": "string",
                    "required": false
                },
                {
                    ...
                    "description": {
                        "zh": "目标分支（可选）",
                        "en": "Target branch (optional).",
                        "ro": "Target branch (optional)."
                    },
                    "type": "string",
                    "required": false
                },
                {
                    ...
                    "description": {
                        "zh": "可选：已知 sha（更新文件时）",
                        "en": "Optional: known sha (when updating a file).",
                        "ro": "Optional: known sha (when updating a file)."
                    },
                    "type": "string",
                    "required": false
                }
        ...
        },
        {
            ...
            "description": {
                "zh": "对仓库文件做差异更新（传入 [START-REPLACE]/[START-DELETE] 块），并提交。",
                "en": "Patch a repository file by applying diff blocks ([START-REPLACE]/[START-DELETE]) and commit.",
                "ro": "Patch a repository file by applying diff blocks ([START-REPLACE]/[START-DELETE]) and commit."
            },
            "parameters": [
                {
                    "name": "owner",
                ...
                },
                {
                    ...
                    "description": {
                        "zh": "差异块字符串（可多块）",
                        "en": "Diff blocks string (can include multiple blocks).",
                        "ro": "Diff blocks string (can include multiple blocks)."
                    },
                    "type": "string",
                    "required": true
                },
        ...
        },
        {
            "name": "delete_file",
            "description": {
                "zh": "删除仓库文件并提交（/repos/{owner}/{repo}/contents/{path}，DELETE）。",
                "en": "Delete a repository file and commit (/repos/{owner}/{repo}/contents/{path}, DELETE).",
                "ro": "Delete a repository file and commit (/repos/{owner}/{repo}/contents/{path}, DELETE)."
            },
            "parameters": [
                {
                    "name": "owner",
                ...
                },
                {
                    ...
                    "description": {
                        "zh": "可选：已知 sha（删除文件时）",
                        "en": "Optional: known sha (when deleting a file).",
                        "ro": "Optional: known sha (when deleting a file)."
                    },
                    "type": "string",
                    "required": false
                }
        ...
        },
        {
            "name": "create_branch",
            "description": {
                "zh": "基于已有分支创建新分支（/git/refs）。",
                "en": "Create a new branch from an existing branch (/git/refs).",
                "ro": "Create a new branch from an existing branch (/git/refs)."
            },
            "parameters": [
                {
                    "name": "owner",
                ...
                },
                {
                    "name": "from_branch",
                    "description": {
                        "zh": "源分支（可选，默认使用 default_branch）",
                        "en": "Source branch (optional; defaults to default_branch).",
                        "ro": "Source branch (optional; defaults to default_branch)."
                    },
                    "type": "string",
                    "required": false
                }
        ...
        },
        {
            ...
            "description": {
                "zh": "使用 Tools.Files.apply 对本地文件做 REPLACE（结构化块）。",
                "en": "Run Tools.Files.apply REPLACE on a local file (structured blocks).",
                "ro": "Run Tools.Files.apply REPLACE on a local file (structured blocks)."
            },
            "parameters": [
                {
                    "name": "path",
                ...
                },
                {
                    ...
                    "description": {
                        "zh": "要替换的旧内容片段",
                        "en": "Old content snippet to replace.",
                        "ro": "Old content snippet to replace."
                    },
                    "type": "string",
                    "required": true
                },
                {
                    ...
                    "description": {
                        "zh": "替换后的新内容片段",
                        "en": "New content snippet.",
                        "ro": "New content snippet."
                    },
                    "type": "string",
                    "required": true
                },
                {
                    ...
                    "description": {
                        "zh": "android/linux（可选）",
                        "en": "android/linux (optional).",
                        "ro": "android/linux (optional)."
                    },
                    "type": "string",
                    "required": false
                }
        ...
        },
        {
            ...
            "description": {
                "zh": "使用 Tools.Files.apply 对本地文件做 DELETE（结构化块）。",
                "en": "Run Tools.Files.apply DELETE on a local file (structured blocks).",
                "ro": "Run Tools.Files.apply DELETE on a local file (structured blocks)."
            },
            "parameters": [
                {
                    "name": "path",
                ...
                },
                {
                    ...
                    "description": {
                        "zh": "要删除的旧内容片段",
                        "en": "Old content snippet to delete.",
                        "ro": "Old content snippet to delete."
                    },
                    "type": "string",
                    "required": true
                },
        ...
        },
        {
            ...
            "description": {
                "zh": "覆盖写入本地文件（如果存在会先删除再写入）。",
                "en": "Overwrite a local file (if it exists, it will be deleted before writing).",
                "ro": "Overwrite a local file (if it exists, it will be deleted before writing)."
            },
            "parameters": [
                {
                    "name": "path",
                ...
                },
                {
                    ...
                    "description": {
                        "zh": "完整文件内容",
                        "en": "Full file content.",
                        "ro": "Full file content."
                    },
                    "type": "string",
                    "required": true
                },
        ...
        },
        {
            "name": "terminal_exec",
            "description": {
                "zh": "在终端会话中执行命令（Tools.System.terminal）。",
                "en": "Execute a command in a terminal session (Tools.System.terminal).",
                "ro": "Execute a command in a terminal session (Tools.System.terminal)."
            },
            "parameters": [
                {
                    "name": "command",
                ...
                },
                {
                    "name": "session_name",
                    "description": {
                        "zh": "会话名（可选，默认 github_tools_session）",
                        "en": "Session name (optional; default: github_tools_session).",
                        "ro": "Session name (optional; default: github_tools_session)."
                    },
                    "type": "string",
                    "required": false
                },
                {
                    ...
                    "description": {
                        "zh": "是否执行后关闭会话",
                        "en": "Whether to close the session after execution.",
                        "ro": "Whether to close the session after execution."
                    },
                    "type": "boolean",
                    "required": false
                }
        ...
        },
        {
            "name": "main",
            "description": {
                "zh": "用于快速连通性自测：拉取一个仓库信息并做一次仓库搜索，然后返回结果。",
                "en": "Quick connectivity self-test: fetch a repository and run a repository search, then return results.",
                "ro": "Quick connectivity self-test: fetch a repository and run a repository search, then return results."
            },
            "parameters": [
                {
                    "name": "owner",
                    "description": {
                        "zh": "仓库 owner（默认 octocat）",
                        "en": "Repository owner (default: octocat).",
                        "ro": "Repository owner (default: octocat)."
                    },
                    "type": "string",
                    "required": false
                },
                {
                    "name": "repo",
                    "description": {
                        "zh": "仓库名（默认 Hello-World）",
                        "en": "Repository name (default: Hello-World).",
                        "ro": "Repository name (default: Hello-World)."
                    },
                    "type": "string",
                    "required": false
                },
                {
                    ...
                    "description": {
                        "zh": "搜索关键词（默认 operit）",
                        "en": "Search keyword (default: operit).",
                        "ro": "Search keyword (default: operit)."
                    },
                    "type": "string",
                    "required": false
                }
