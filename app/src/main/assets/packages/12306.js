/* METADATA
{
    ...
    "description": {
        "zh": "提供12306火车票信息查询功能，包括余票、中转、经停站等。",
        "en": "Query China Railway 12306 train ticket information, including availability, transfer routes, and stop stations.",
        "ro": "Query China Railway 12306 train ticket information, including availability, transfer routes, and stop stations."
    },
    ...
    "tools": [
        {
            ...
            "description": {
                ...
                "ro": "Get the current date in the Shanghai timezone (Asia/Shanghai, UTC+8). Returns format 'yyyy-MM-dd'. Mainly used to resolve relative dates (e.g. \"tomorrow\", \"next Wednesday\") and provide correct date input for other APIs."
            },
            "parameters": []
        },
        {
            ...
            "description": {
                "zh": "通过中文城市名查询该城市 **所有** 火车站的名称及其对应的 `station_code`，结果是一个包含多个车站信息的列表。",
                "en": "Given a Chinese city name, list **all** train stations in that city and their corresponding `station_code`.",
                "ro": "Given a Chinese city name, list **all** train stations in that city and their corresponding `station_code`."
            },
            "parameters": [
                {
                    "name": "city",
                    "description": {
                        ...
                        "ro": "Chinese city name, e.g. '北京', '上海'."
                    },
                    "type": "string",
                    "required": true
                }
        ...
        },
        {
            ...
            "description": {
                "zh": "通过中文城市名查询代表该城市的 `station_code`。此接口主要用于在用户提供**城市名**作为出发地或到达地时，为接口准备 `station_code` 参数。",
                "en": "Get the representative `station_code` for a Chinese city name. Use this when the user provides a **city name** as origin/destination and you need a `station_code`.",
                "ro": "Get the representative `station_code` for a Chinese city name. Use this when the user provides a **city name** as origin/destination and you need a `station_code`."
            },
            "parameters": [
                {
                    "name": "citys",
                    "description": {
                        ...
                        "ro": "City to query, e.g. '北京'. For multiple cities, separate with |, e.g. '北京|上海'."
                    },
                    "type": "string",
                    "required": true
                }
        ...
        },
        {
            ...
            "description": {
                ...
                "ro": "Given a specific Chinese station name, return its `station_code` and station name. Use this when the user provides a **specific station name** for origin/destination."
            },
            "parameters": [
                {
                    "name": "station_names",
                    "description": {
                        ...
                        "ro": "Specific Chinese station names, e.g. '北京南', '上海虹桥'. For multiple stations, separate with |, e.g. '北京南|上海虹桥'."
                    },
                    "type": "string",
                    "required": true
                }
        ...
        },
        {
            ...
            "description": {
                ...
                "ro": "Query station details by `station_telecode`, including name, pinyin, city, etc. Mainly for getting more complete station data when `telecode` is known, or for special queries/debugging."
            },
            "parameters": [
                {
                    ...
                    "description": {
                        ...
                        "ro": "Station `station_telecode` (3-letter code)."
                    },
                    "type": "string",
                    "required": true
                }
        ...
        },
        {
            ...
            "description": {
                "zh": "查询12306余票信息。",
                "en": "Query 12306 ticket availability.",
                "ro": "Query 12306 ticket availability."
            },
            "parameters": [
                {
                    "name": "date",
                    "description": {
                        ...
                        "ro": "Query date in 'yyyy-MM-dd'. If the user gives a relative date (e.g. \"tomorrow\"), call `get_current_date` first and compute the target date."
                    },
                    "type": "string",
                    "required": true
                },
                {
                    ...
                    "description": {
                        ...
                        "ro": "Origin `station_code`. Must be obtained via `get_station_code_by_names` or `get_station_code_of_citys` (do NOT pass Chinese names directly)."
                    },
                    "type": "string",
                    "required": true
                },
                {
                    ...
                    "description": {
                        ...
                        "ro": "Destination `station_code`. Must be obtained via `get_station_code_by_names` or `get_station_code_of_citys` (do NOT pass Chinese names directly)."
                    },
                    "type": "string",
                    "required": true
                },
                {
                    ...
                    "description": {
                        "zh": "车次筛选条件，默认为空，即不筛选。支持多个标志同时筛选。例如用户说“高铁票”，则应使用 'G'。可选标志：[G(高铁/城际),D(动车),Z(直达特快),T(特快),K(快速),O(其他),F(复兴号),S(智能动车组)]",
                        "en": "Train filter flags. Default empty (no filter). Can combine multiple flags. Example: for high-speed rail, use 'G'. Options: [G(High-speed/Intercity),D(EMU),Z(Direct express),T(Express),K(Fast),O(Other),F(Fuxing),S(Smart EMU)].",
                        "ro": "Train filter flags. Default empty (no filter). Can combine multiple flags. Example: for high-speed rail, use 'G'. Options: [G(High-speed/Intercity),D(EMU),Z(Direct express),T(Express),K(Fast),O(Other),F(Fuxing),S(Smart EMU)]."
                    },
                    "type": "string",
                    "required": false
                },
                {
                    ...
                    "description": {
                        ...
                        "ro": "Sort mode. Default empty (no sorting). Only one mode is supported. Options: [startTime (earliest departure), arriveTime (earliest arrival), duration (shortest duration)]."
                    },
                    "type": "string",
                    "required": false
                },
                {
                    ...
                    "description": {
                        ...
                        "ro": "Reverse sort order (default: false). Only effective when sort_flag is set."
                    },
                    "type": "boolean",
                    "required": false
                },
                {
                    "name": "limited_num",
                    "description": {
                        "zh": "返回的余票数量限制，默认为0，即不限制。",
                        "en": "Limit number of returned results (default: 0, no limit).",
                        "ro": "Limit number of returned results (default: 0, no limit)."
                    },
                    "type": "number",
                    "required": false
                }
        ...
        },
        {
            ...
            "description": {
                "zh": "查询12306中转余票信息。尚且只支持查询前十条。",
                "en": "Query 12306 transfer (interline) ticket availability. Currently only supports the first 10 results.",
                "ro": "Query 12306 transfer (interline) ticket availability. Currently only supports the first 10 results."
            },
            "parameters": [
                {
                    "name": "date",
                    "description": {
                        ...
                        "ro": "Query date in 'yyyy-MM-dd'. If the user gives a relative date, call `get_current_date` first and compute the target date."
                    },
                    "type": "string",
                    "required": true
                },
                {
                    "name": "from_station",
                    "description": {
                        "zh": "出发地的 `station_code` 。必须是通过 `get-station_code_by_names` 或 `get_station_code_of_citys` 接口查询得到的编码，严禁直接使用中文地名。",
                        "en": "Origin `station_code`. Must be obtained via station-code lookup APIs (do NOT pass Chinese names directly).",
                        "ro": "Origin `station_code`. Must be obtained via station-code lookup APIs (do NOT pass Chinese names directly)."
                    },
                    "type": "string",
                    "required": true
                },
                {
                    ...
                    "description": {
                        ...
                        "ro": "Destination `station_code`. Must be obtained via station-code lookup APIs (do NOT pass Chinese names directly)."
                    },
                    "type": "string",
                    "required": true
                },
                {
                    "name": "middle_station",
                    "description": {
                        "zh": "中转地的 `station_code` ，可选。必须是通过 `get-station-code-by-names` 或 `get-station_code_of_citys` 接口查询得到的编码，严禁直接使用中文地名。",
                        ...
                        "ro": "Optional transfer station `station_code`. Must be obtained via station-code lookup APIs (do NOT pass Chinese names directly)."
                    },
                    "type": "string",
                    "required": false
                },
                {
                    ...
                    "description": {
                        ...
                        "ro": "Whether to include no-seat (无座) tickets (default: false)."
                    },
                    "type": "boolean",
                    "required": false
                },
                {
                    "name": "train_filter_flags",
                    "description": {
                        "zh": "车次筛选条件，默认为空。从以下标志中选取多个条件组合[G(高铁/城际),D(动车),Z(直达特快),T(特快),K(快速),O(其他),F(复兴号),S(智能动车组)]",
                        "en": "Train filter flags. Default empty. Combine multiple flags from: [G(High-speed/Intercity),D(EMU),Z(Direct express),T(Express),K(Fast),O(Other),F(Fuxing),S(Smart EMU)].",
                        "ro": "Train filter flags. Default empty. Combine multiple flags from: [G(High-speed/Intercity),D(EMU),Z(Direct express),T(Express),K(Fast),O(Other),F(Fuxing),S(Smart EMU)]."
                    },
                    "type": "string",
                    "required": false
                },
                {
                    ...
                    "description": {
                        ...
                        "ro": "Sort mode. Default empty. Options: startTime / arriveTime / duration."
                    },
                    "type": "string",
                    "required": false
                },
                ...
                },
                {
                    "name": "limited_num",
                    "description": {
                        "zh": "返回的中转余票数量限制，默认为10。",
                        "en": "Limit number of returned results (default: 10).",
                        "ro": "Limit number of returned results (default: 10)."
                    },
                    "type": "number",
                    "required": false
                }
        ...
        },
        {
            ...
            "description": {
                "zh": "查询特定列车车次在指定区间内的途径车站、到站时间、出发时间及停留时间等详细经停信息。当用户询问某趟具体列车的经停站时使用此接口。",
                "en": "Query detailed stop information for a specific train within a segment, including stations, arrival/departure times, and stop duration. Use when the user asks for stops of a specific train.",
                "ro": "Query detailed stop information for a specific train within a segment, including stations, arrival/departure times, and stop duration. Use when the user asks for stops of a specific train."
            },
            "parameters": [
                {
                    "name": "train_no",
                    "description": {
                        ...
                        "ro": "Actual train number `train_no`, e.g. '240000G10336' (not 'G1033'). Usually obtained from `get_tickets` results or provided by the user."
                    },
                    "type": "string",
                    "required": true
                },
                {
                    ...
                    "description": {
                        ...
                        "ro": "`station_telecode` (3-letter code) of the **origin station**. Usually from `telecode` fields in `get_tickets`, or obtained via station code lookup."
                    },
                    "type": "string",
                    "required": true
                },
                {
                    ...
                    "description": {
                        "zh": "该列车行程的**到达站**的 `station_telecode` (3位字母编码)。通常来自 `get_tickets` 结果中的 `telecode` 字段，或者通过 `get-station_code_by_names` 得到。",
                        ...
                        "ro": "`station_telecode` (3-letter code) of the **destination station**. Usually from `telecode` fields in `get_tickets`, or obtained via station code lookup."
                    },
                    "type": "string",
                    "required": true
                },
                {
                    ...
                    "description": {
                        ...
                        "ro": "Departure date from the origin station (format: yyyy-MM-dd). If the user provides a relative date, resolve it via `get_current_date`."
                    },
                    "type": "string",
                    "required": true
                }
